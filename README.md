...
Tesla, Inc. adalah sebuah perusahaan kendaraan yang berasal dari Amerika Serikat dan didirikan pada tahun 2003 oleh Martin Eberhard dan Marc Tarpenning. Tesla dikenal sebagai salah satu yang terdepan dalam inovasi mobil listrik serta penerapan teknologi kecerdasan buatan di sektor otomotif.

Salah satu terobosan pentingnya adalah fitur **Autopilot** dan **Full Self-Driving (FSD)**, yang merupakan sistem Bantuan Pengemudi Canggih yang dirancang untuk mendukung pengemudi dengan berbagai fitur seperti **Traffic-Aware Cruise Control**, **Autosteer**, dan **Automatic Emergency Braking**. FSD juga memiliki fungsi tambahan, antara lain berpindah jalur otomatis, mengenali tanda lalu lintas, serta membantu proses parkir.

Meski demikian, menurut kategori yang ditetapkan oleh **Society of Automotive Engineers (SAE)**, Autopilot dan FSD masih masuk dalam **Level 2 Automasi Berkendara**, sehingga pengemudi tetap memiliki tanggung jawab penuh atas pengendalian kendaraan.

Kasus Tesla Autopilot diambil sebagai contoh penting dalam diskusi mengenai rekayasa perangkat lunak dan etika profesi. Berbagai insiden yang melibatkan kendaraan Tesla saat menggunakan Autopilot dan FSD menimbulkan pertanyaan terkait keamanan sistem, tanggung jawab perusahaan, serta perilaku pengguna. Situasi ini mendorong **National Highway Traffic Safety Administration (NHTSA)** untuk melakukan penyelidikan guna menilai apakah sistem Autopilot telah memenuhi persyaratan keselamatan yang ditetapkan.

Kasus ini memiliki relevansi dalam mata kuliah Etika Profesi karena menunjukkan bahwa pengembangan perangkat lunak tidak hanya harus fokus pada inovasi, tetapi juga harus mengedepankan keselamatan pengguna, keterbukaan informasi, serta tanggung jawab profesional. Autopilot termasuk dalam kategori perangkat lunak yang krusial untuk keselamatan, di mana kegagalan dalam sistem dapat menyebabkan cedera parah bahkan kematian. Karena itu, setiap tahap dari pengembangan, pengujian, hingga penerapan harus dilakukan dengan teliti dan sesuai dengan standar keselamatan yang berlaku.

Penerapan etika profesi sangat krusial dalam pengembangan perangkat lunak yang berisiko tinggi. Insinyur perangkat lunak memiliki tanggung jawab untuk memastikan bahwa sistem telah menjalani proses pengujian yang cukup serta memberikan informasi yang jelas tentang kemampuan dan batasan dari sistem tersebut. Kasus Tesla Autopilot menunjukkan bahwa kekeliruan dalam pengembangan maupun penyampaian informasi dapat berpengaruh langsung pada keselamatan manusia. Oleh karena itu, setiap inovasi teknologi harus senantiasa mengutamakan keselamatan, tanggung jawab, dan kepentingan masyarakat.

---

## 1.2 Kronologi Kejadian

Penyelidikan mengenai Tesla Autopilot dimulai akibat serangkaian kecelakaan yang terjadi di berbagai lokasi di Amerika Serikat. Salah satu peristiwa yang menarik perhatian terjadi pada tahun 2021, ketika sebuah mobil Tesla dengan fitur Autopilot menabrak kendaraan darurat yang berhenti di tepi jalan. Insiden serupa juga dilaporkan di beberapa negara bagian lainnya, termasuk Florida, California, Michigan, dan Utah. Sebagian besar kecelakaan ini terjadi di jalan tol, khususnya pada malam hari atau ketika jarak pandang terbatas, yang menimbulkan kecurigaan bahwa sistem mengalami kesulitan dalam mendeteksi objek tertentu.

Pada bulan **Agustus 2021**, **National Highway Traffic Safety Administration (NHTSA)** secara resmi memulai penyelidikan terhadap sistem Autopilot dari Tesla. Penyelidikan dilakukan dengan mengevaluasi laporan kecelakaan, data dari kendaraan, serta cara kerja sistem untuk memahami apakah ada kelemahan dalam mendeteksi kendaraan yang berhenti dan apakah mekanisme pemantauan pengemudi berfungsi dengan baik.

Hasil dari penyelidikan mengungkapkan bahwa di beberapa kasus, pengemudi terlalu mengandalkan sistem, dan mekanisme pemantauan pengemudi dinilai belum cukup efektif untuk menjaga perhatian pengemudi saat berkendara.

Sebagai langkah lanjutan, pada bulan **Desember 2023**, Tesla melakukan penarikan lebih dari dua juta kendaraannya melalui pembaruan perangkat lunak. Pembaruan ini bertujuan untuk meningkatkan sistem pemantauan pengemudi, memperkuat peringatan ketika perhatian pengemudi mulai menurun, serta membatasi penggunaan Autopilot dalam situasi tertentu.

Namun, pada tahun **2024**, NHTSA kembali menilai efektivitas pembaruan ini setelah mendapati masih ada beberapa kecelakaan yang melibatkan kendaraan Tesla.

Hingga tahun **2025**, penyelidikan masih berlanjut dengan fokus tidak hanya pada Autopilot, tetapi juga pada **Full Self-Driving (FSD)**. Penyelidikan ini bertujuan untuk menilai kemampuan sistem dalam menghadapi kondisi cuaca yang buruk, visibilitas yang rendah, serta kemampuannya mengenali berbagai objek di sekitar kendaraan.

---

## 1.3 Konteks Teknis

Autopilot dan **Full Self-Driving (FSD)** berfungsi dengan memanfaatkan gabungan kamera, sensor mobil, GPS, dan kecerdasan buatan. Kamera yang terpasang di kendaraan mengamati lingkungan di sekitarnya secara langsung, lalu data tersebut diproses menggunakan algoritma *Machine Learning* untuk mengidentifikasi kendaraan lain, pejalan kaki, marka jalan, lampu lalu lintas, serta berbagai objek di sekitar mobil.

Berdasarkan data yang diolah, sistem dapat membantu mengarahkan kemudi, mengontrol kecepatan, melakukan pengereman otomatis, dan menjaga agar mobil tetap berada di jalur yang benar. Pada versi terbaru, Tesla mengadopsi pendekatan **Tesla Vision**, yang lebih menekankan penggunaan kamera dibandingkan radar untuk memahami lingkungan sekitar.

Walaupun memiliki teknologi modern, Autopilot dan FSD belum dapat mengemudi sepenuhnya sendiri dalam semua situasi. Kedua sistem ini masih termasuk dalam kategori **SAE Level 2 Driving Automation**, sehingga pengemudi tetap harus bertanggung jawab sepenuhnya atas kendali kendaraan. Kinerja sistem dapat menurun dalam beberapa kondisi, seperti saat hujan deras, kabut, sinar matahari yang menyilaukan, marka jalan yang samar, atau objek yang sulit dikenali oleh kamera. Oleh karena itu, Tesla menekankan pentingnya pengemudi untuk tetap waspada terhadap kondisi jalan dan siap mengambil alih kendali kapan saja.

Menurut hasil penelitian dari **National Highway Traffic Safety Administration (NHTSA)**, ada beberapa faktor yang diduga menjadi penyebab kecelakaan yang melibatkan Autopilot. Faktor pertama adalah keterbatasan sistem dalam mengidentifikasi kendaraan darurat atau objek lain dalam kondisi cuaca dan pencahayaan tertentu. Faktor kedua adalah tidak optimalnya pemantauan perhatian pengemudi, yang dapat mengakibatkan pengemudi kehilangan konsentrasi saat Autopilot aktif. Selain itu, faktor manusia juga berkontribusi, yaitu kecenderungan beberapa pengguna untuk terlalu bergantung pada kemampuan Autopilot dan menggunakannya di luar kondisi yang dianjurkan. Perpaduan antara keterbatasan teknologi dan kesalahan penggunaan inilah yang menjadi pokok perhatian dalam penyelidikan serta menunjukkan pentingnya penerapan etika profesional dalam pengembangan perangkat lunak yang berkaitan dengan keselamatan manusia.
...
Tesla adalah perusahaan mobil yang mengembangkan sistem bantuan mengemudi seperti **Autopilot** dan **Full Self-Driving (FSD)** untuk meningkatkan kenyamanan serta keamanan berkendara. Meskipun kedua sistem ini cukup maju, keduanya masih dianggap sebagai **Level 2 Driving Automation**, yang mengharuskan pengemudi untuk tetap memantau kendaraan dan siap mengambil kendali kapan pun diperlukan.

Pada **Agustus 2021**, **National Highway Traffic Safety Administration (NHTSA)** resmi memulai investigasi terhadap sistem Autopilot setelah menerima laporan tentang beberapa kecelakaan yang melibatkan mobil Tesla, terutama ketika kendaraan tersebut menabrak mobil darurat yang berhenti di tepi jalan. Penyelidikan ini bertujuan untuk menilai kemampuan sistem dalam mengenali objek di jalan dan mengevaluasi efektivitas cara pemantauan perhatian pengemudi. Investigasi ini telah dipublikasikan secara resmi oleh NHTSA.

Pada bulan **Desember 2023**, Tesla menarik kembali lebih dari dua juta kendaraan melalui pembaruan perangkat lunak. Pembaruan ini ditujukan untuk memperbaiki sistem pemantauan pengemudi, meningkatkan peringatan saat pengemudi kehilangan fokus, serta membatasi penggunaan Autopilot dalam kondisi tertentu sesuai saran NHTSA. Penarikan ini adalah langkah resmi yang diumumkan oleh Tesla dan diawasi oleh NHTSA.

Selain itu, sampai tahun **2025**, NHTSA masih melanjutkan penyelidikan mengenai efektivitas pembaruan perangkat lunak yang telah dilakukan oleh Tesla. Hal ini menunjukkan bahwa pihak regulator masih menilai apakah perubahan tersebut dapat secara signifikan mengurangi risiko terjadinya kecelakaan.

---

## 2.2 Informasi yang Masih Dalam Investigasi

Meskipun beberapa informasi telah dikonfirmasi, masih ada beberapa hal yang belum mendapatkan keputusan akhir dari pihak regulator. Salah satu di antaranya adalah apakah seluruh kecelakaan yang melibatkan Tesla Autopilot benar-benar disebabkan oleh masalah pada sistem atau dipengaruhi oleh faktor lain, seperti keadaan jalan, cuaca, atau perilaku pengemudi.

NHTSA masih melakukan penilaian terhadap efektivitas pembaruan perangkat lunak yang dirilis oleh Tesla pada akhir tahun 2023. Penilaian ini dilakukan karena masih ada laporan tentang kecelakaan yang melibatkan mobil Tesla setelah pembaruan tersebut diterapkan. Oleh karena itu, regulator sedang menyelidiki apakah pembaruan itu sudah memberikan peningkatan keselamatan yang cukup atau apakah masih ada kekurangan pada sistem Autopilot dan Full Self-Driving.

Selain dari segi teknis, proses penyelidikan juga tengah menilai apakah desain antarmuka dan sistem peringatan yang diterapkan oleh Tesla sudah efektif untuk memastikan pengemudi tetap memperhatikan kondisi jalan saat menggunakan fitur bantuan mengemudi.

Hingga saat ini belum ada keputusan akhir yang menunjukkan adanya kesalahan teknis tertentu sebagai penyebab utama dari semua kecelakaan yang terjadi.
...
|-----------------|------------|--------|
| **Fakta** | National Highway Traffic Safety Administration (NHTSA) memulai penyelidikan resmi terhadap fitur Autopilot Tesla pada Agustus 2021 setelah terjadi sejumlah kecelakaan yang melibatkan kendaraan Tesla dengan kendaraan darurat di Amerika Serikat. | Telah dikonfirmasi melalui laporan resmi NHTSA. |
| **Fakta** | Pada Desember 2023, Tesla mengeluarkan pembaruan perangkat lunak sebagai bagian dari proses *recall* terhadap lebih dari dua juta kendaraan untuk meningkatkan sistem pemantauan pengemudi. | Didukung oleh pengumuman resmi Tesla dan NHTSA. |
| **Fakta** | Sampai tahun 2025, NHTSA masih melanjutkan penyelidikan guna mengevaluasi efektivitas pembaruan perangkat lunak yang telah diterapkan Tesla. | Berdasarkan dokumen investigasi resmi NHTSA. |
| **Dugaan** | Salah satu kemungkinan yang masih diteliti adalah apakah keterbatasan sistem Autopilot dalam mengenali objek pada kondisi tertentu turut berkontribusi terhadap terjadinya kecelakaan. | Belum menjadi kesimpulan akhir dan masih dalam proses investigasi. |
| **Dugaan** | Efektivitas pembaruan perangkat lunak yang dirilis Tesla pada akhir tahun 2023 masih terus dievaluasi untuk mengetahui sejauh mana pembaruan tersebut dapat meningkatkan keselamatan berkendara. | Masih menjadi bagian dari penyelidikan NHTSA. |
| **Opini** | Sejumlah pihak menilai bahwa penyebutan **"Full Self-Driving"** berpotensi menimbulkan persepsi bahwa kendaraan dapat beroperasi secara mandiri, sehingga dapat memengaruhi ekspektasi pengguna. | Merupakan pendapat dari berbagai pihak dan bukan hasil keputusan resmi regulator. |
| **Opini** | Beberapa pengamat berpendapat bahwa strategi komunikasi Tesla mengenai kemampuan Autopilot perlu dibuat lebih jelas agar pengguna memahami batasan sistem dengan lebih baik. | Merupakan pandangan atau penilaian yang belum ditetapkan sebagai fakta oleh regulator. |
...
(Tuliskan isi ringkas dari laporan)
